...
def read_version():
    ...
    if version_file.exists():
        ...
        # Extract version like v1.18.0 from "// v1.18.0-dev"
        match = re.search(r'v[\d.]+-?\w*', content)
        if match:
...
def generate_header(files, output_path, version):
...
def main():
    ...
    print('=' * 60)
    generate_header(files, output_file, version)
    print('=' * 60)
    print('Done! Web assets embedded successfully.')
    print(f'Version {version} injected into web assets.')
